...
var ServerID = "511571107254501376"; 
var ChannelID = "517973447716896779";//

var ChannelIID = "517973650079481866";

const pr1 = ['488640450484502528' , '' , ''];
...
client.on('ready', () => {
  client.channels.find(ch => ch.id === "511820516680794112" && ch.type === 'voice').join();//اكتب اي دي روم صوت هنا
});//By Rie
